        ...
        <div class="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            <div class="max-w-2xl lg:col-span-7 reveal">
                ...
                <h1 class="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-dark leading-tight md:leading-[1.2] tracking-tight mb-6">
                    Premium Quality <span class="text-botanical">Essential Oil Collection</span>
                </h1>
                <p class="text-base md:text-base text-dark/80 leading-relaxed mb-10 max-w-xl">
                    Discover a wide selection of 100% pure essential oils from the best sources in Indonesia. We guarantee the quality and purity of every drop of our products.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="product-card p-6 cursor-pointer reveal flex flex-col relative">
                ...
                <div class="mb-2">
                    <h3 class="font-heading text-md font-bold text-dark mb-1">{{ $product->english_name }}</h3>
            ...
            <div class="col-span-full text-center py-12">
                <p class="text-dark/70">No products available yet.</p>
            </div>
            @endforelse
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-20 md:py-28">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="font-heading text-3xl md:text-4xl font-bold text-white leading-tight mb-6">
                Don't Find the Product You're Looking For?
            </h2>
            <p class="text-base text-white/80 leading-relaxed mb-10 max-w-2xl mx-auto">
                We have an extensive network with essential oil farmers throughout Indonesia. Contact us to discuss your specific needs for essential oil raw materials.
            </p>
