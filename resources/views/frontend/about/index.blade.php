...
<section class="hero-gradient relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 md:py-32 text-center">
        <div class="max-w-3xl mx-auto reveal">
            ...
            <h1 class="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight mb-8">
                Mitra Strategis Untuk Kebutuhan <span class="text-botanical-light">Bahan Baku Atsiri</span>
            </h1>

            <p class="text-lg text-white/80 leading-relaxed mb-0 max-w-2xl mx-auto">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="reveal reveal-delay-2">
                ...
                <div class="prose prose-lg text-dark/80">
                    <p>
                        Berawal dari visi untuk mengangkat potensi alam Indonesia, <strong>Sentra Essential Oil</strong> hadir sebagai solusi rantai pasok bahan baku minyak atsiri yang andal, transparan, dan berkelanjutan. 
                    </p>
                    <p>
                        Kami memahami bahwa dalam industri manufaktur—baik itu farmasi, kosmetik, maupun personal care—konsistensi kualitas dan kestabilan pasokan adalah nyawa dari sebuah produksi. Oleh karena itu, kami membangun kemitraan langsung dengan para penyuling lokal di berbagai sentra penghasil atsiri di seluruh Indonesia.
                    </p>
                    <p>
                        Dengan memotong rantai distribusi yang panjang, kami mampu menjamin ketertelusuran (traceability) produk, memastikan bahwa setiap tetes minyak atsiri yang sampai ke fasilitas Anda adalah 100% murni, telah melewati penyaringan fisik yang ketat, dan siap memenuhi standar ekspor.
                    </p>
                </div>
            </div>
...
<section class="bg-surface-alt py-20 md:py-28">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            {{-- Value 1 --}}
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-border/50 reveal">
                <div class="w-14 h-14 bg-botanical-muted rounded-xl flex items-center justify-center text-botanical mb-6">
                    <svg class="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Integritas Kualitas (Purity)</h3>
            ...
            {{-- Value 2 --}}
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-border/50 reveal reveal-delay-1">
                <div class="w-14 h-14 bg-earth-muted rounded-xl flex items-center justify-center text-earth mb-6">
                    <svg class="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                </div>
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Kontinuitas Pasokan</h3>
                <p class="text-dark/70 leading-relaxed">
                    Melalui jaringan hulu yang terintegrasi, kami mampu menjaga kestabilan volume pasokan untuk memenuhi target produksi industri Anda secara konsisten.
                </p>
            </div>

            {{-- Value 3 --}}
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-border/50 reveal reveal-delay-2">
                <div class="w-14 h-14 bg-accent-light/10 rounded-xl flex items-center justify-center text-accent mb-6">
                    <svg class="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                </div>
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Kemitraan Jangka Panjang</h3>
                <p class="text-dark/70 leading-relaxed">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="reveal">
                ...
                <ul class="space-y-4 text-dark/80">
...
{{-- ============================================
     SECTION 5: CTA
     ============================================ --}}
<section class="py-20 md:py-28 bg-dark relative overflow-hidden">
    <div class="absolute inset-0 bg-gradient-to-br from-dark via-dark to-botanical-dark opacity-90"></div>
    <div class="absolute top-0 right-0 w-96 h-96 bg-botanical rounded-full blur-[120px] opacity-20 transform translate-x-1/3 -translate-y-1/3"></div>
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-earth rounded-full blur-[120px] opacity-20 transform -translate-x-1/3 translate-y-1/3"></div>
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center reveal">
        <h2 class="font-heading text-3xl md:text-5xl font-bold text-white mb-6">
            Siap Memenuhi Kebutuhan Bahan Baku Anda?
        </h2>
        <p class="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
            Diskusikan spesifikasi produk, permintaan sampel, atau kontrak pasokan jangka panjang bersama tim representatif kami.
        </p>
